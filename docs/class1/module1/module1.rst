Module - Implement C3D with APM Enhancements
=============================================
...
The F5 Client Certificate Constrained Delegation (C3D) capability allows the best of both worlds by allowing MFA at the proxy layer while maintaining strong security when performing SSO between the proxy and backend resource.
